...
public class Calculator {
	...
	private void calculateMain() {
		...
		for(int i=0; i<tokens.length; i++) {
			if(! tokens[i].equals("") && ! tokens[i].equals(" ") && ! tokens[i].equals("\n") && ! tokens[i].equals("  ")) {
				t.add(tokens[i]);  //adding token to token array list from expression 
			}
		}
		try {
	...
	private void initialize() {
		...
		button12.setBackground(new Color(250, 250, 250));
		...
		button14.setBackground(new Color(250, 250, 250));
		...
		button18.setBackground(new Color(250, 250, 250));
		...
		button22.setBackground(new Color(250, 250, 250));
		...
		button24.setBackground(new Color(250, 250, 250));
		...
		button28.setBackground(new Color(250, 250, 250));
